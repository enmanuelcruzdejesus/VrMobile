...
namespace XamCore.Utils.Services
{
    public class ResilienceHttpClient : IHttpClient
    {
        ...
        public Task<HttpResponseMessage> GetAsync(string controller,string action, string authorizationToken = null, string authorizationMethod = "Bearer")
        {
            return _policy.ExecuteAsync(async () =>
            {
                var uri = new Uri(String.Format(_url, controller, action , string.Empty));
        ...
        public Task<HttpResponseMessage> GetByIdAsync(string controller, string action,  string id, string authorizationToken = null, string authorizationMethod = "Bearer")
        {


            return _policy.ExecuteAsync(async () =>
            {
                var uri = new Uri(String.Format(_url, controller, action,id));
                _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(
                       authorizationMethod,
                       authorizationToken
                   );
        ...
        public Task<HttpResponseMessage> PutAsync<T>(string controller, string action ,  T item, string authorizationToken = null, string requestId = null, string authorizationMethod = "Bearer")
        {
            return _policy.ExecuteAsync(async () =>
            {
                var uri = new Uri(string.Format(_url, controller, action ,  string.Empty));
        ...
        public Task<HttpResponseMessage> PostAsync<T>(string controller, string action ,  T item, string authorizationToken = null, string requestId = null, string authorizationMethod = "Bearer")
        {
            return _policy.ExecuteAsync(async () =>
            {
                var uri = new Uri(string.Format(_url, controller, action , string.Empty));
